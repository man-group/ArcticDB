...
ArrowOutputStringFormat ArrowStringHandler::output_string_format(
    ...
    // TODO: Remove the std::string construction
...
void encode_variable_length(
    ...
    if (mapping.num_rows_ == 0) {
        // TODO: Is this necessary. Maybe assertion is better
        return;
    }
    ...
    // TODO: Comment why we're getting dest_ptr even though it usally gets allocated
    auto dest_ptr = reinterpret_cast<OffsetType*>(dest_column.bytes_at(mapping.offset_bytes_, mapping.dest_bytes_));
    std::vector<std::string_view> strings; // TODO: Try populating directly a char vector
    util::BitSet dest_bitset;
    util::BitSet::bulk_insert_iterator inserter(dest_bitset); // TODO: Duplicated
    ...
    inserter.flush(); // TODO: A lot of duplication
    if (populate_inverted_bitset) {
