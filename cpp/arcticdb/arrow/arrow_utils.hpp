...
std::pair<std::vector<Column>, entity::StreamDescriptor> record_batches_to_columns(const std::vector<sparrow::record_batch>& record_batches, bool has_index = false);
