            ...
            symbol_structure_(symbol_structure)
{
    ...
    stream_ids_ = segment_.column_ptr(*segment_.column_index("stream_id"));
    version_ids_ = segment_.column_ptr(*segment_.column_index("version_id"));
    creation_timestamps_ = segment_.column_ptr(*segment_.column_index("creation_ts"));
    content_hashes_ = segment_.column_ptr(*segment_.column_index("content_hash"));
    start_indexes_ = segment_.column_ptr(*segment_.column_index("start_index"));
    end_indexes_ = segment_.column_ptr(*segment_.column_index("end_index"));
    key_types_ = segment_.column_ptr(*segment_.column_index("key_type"));
