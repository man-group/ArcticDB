...
//     if constexpr (std::is_same_v<RawType, bool>) {
//         std::vector<bool> expected_values{false, false, true, true, true, false, true, true, false, false, false,
//         true}; for (size_t idx = 0; idx < total_rows; ++idx) {
...
//                    }
//                } else { // Fixed-width
//                    // Needed to pad with null bytes to the width of the widest string, as this is how numpy
//                    fixed-width
//                    // strings work
//                    auto width =
...
//    input_columns.emplace_back(column_with_strings({"ascii dynamic", "dynamic", "hello"},
//    ascii_dynamic_td.data_type())
//    );
...
//    }
//    input_columns.clear(); // In debug builds there are checks that the reslicer has the last reference to input
//    columns
//
...
//        ASSERT_TRUE(opt_val.has_value());
//        ASSERT_EQ(*opt_val, in_col_0 ? expected_offsets_0.at(expected_string) :
//        expected_offsets_1.at(expected_string)); ASSERT_EQ(
