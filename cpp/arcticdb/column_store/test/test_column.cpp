...
void test_column_type(size_t num_values = 20, size_t num_tests = 50) {
  ...
  for (size_t j = 0; j < num_tests; ++j) {
    ...
    //         raw_type val = 0;
    //         ASSERT_NO_THROW(column.visit(index, [&](auto &&x) { assign(*x.data(),
    //         val); })); ASSERT_EQ(val, start);
  }
}
...
TEST(Column, ScalarTypes) {
  ...
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT16>,
                                     DimensionTag<Dimension::Dim0>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT32>,
                                     DimensionTag<Dimension::Dim0>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT64>,
                                     DimensionTag<Dimension::Dim0>>>();
  test_column_type<
  ...
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::FLOAT32>,
                                     DimensionTag<Dimension::Dim0>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::FLOAT64>,
                                     DimensionTag<Dimension::Dim0>>>();
}

TEST(Column, TensorTypes) {
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT8>,
  ...
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT64>,
                                     DimensionTag<Dimension ::Dim1>>>();
  test_column_type<
      TypeDescriptorTag<DataTypeTag<DataType::INT8>, DimensionTag<Dimension ::Dim1>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::INT16>,
                                     DimensionTag<Dimension ::Dim1>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::INT32>,
                                     DimensionTag<Dimension ::Dim1>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::INT64>,
                                     DimensionTag<Dimension ::Dim1>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::FLOAT32>,
                                     DimensionTag<Dimension ::Dim1>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::FLOAT64>,
  ...
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::UINT64>,
                                     DimensionTag<Dimension ::Dim2>>>();
  test_column_type<
      TypeDescriptorTag<DataTypeTag<DataType::INT8>, DimensionTag<Dimension ::Dim2>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::INT16>,
                                     DimensionTag<Dimension ::Dim2>>>();
  test_column_type<TypeDescriptorTag<DataTypeTag<DataType::INT32>,
                                     DimensionTag<Dimension ::Dim2>>>();
...
TEST(Column, IterateData) {
  using TDT =
      TypeDescriptorTag<DataTypeTag<DataType::UINT16>, DimensionTag<Dimension ::Dim0>>;
...
std::unique_ptr<Column> get_sparse_column(size_t offset = 0, size_t start = 0,
                                          size_t num_rows = 10) {
  using TDT =
      TypeDescriptorTag<DataTypeTag<DataType::INT64>, DimensionTag<Dimension ::Dim0>>;
  auto column =
      std::make_unique<Column>(static_cast<TypeDescriptor>(TDT{}), 0, false, true);
...
std::unique_ptr<Column> get_dense_column(size_t offset = 0, size_t start = 0,
                                         size_t num_rows = 10) {
  using TDT =
      TypeDescriptorTag<DataTypeTag<DataType::INT64>, DimensionTag<Dimension ::Dim0>>;
  auto column =
