...
SegmentInMemory::SegmentInMemory(
    ...
    impl_(std::make_shared<SegmentInMemoryImpl>(tsd, expected_column_size, allocation_type, allow_sparse)) {}

SegmentInMemory::SegmentInMemory(
        StreamDescriptor&& tsd, size_t expected_column_size, AllocationType allocation_type, Sparsity allow_sparse
) :
    impl_(std::make_shared<SegmentInMemoryImpl>(std::move(tsd), expected_column_size, allocation_type, allow_sparse)) {}
