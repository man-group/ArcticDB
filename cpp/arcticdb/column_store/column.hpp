...
class Column {
  public:
    ...
    class TypedColumnIterator
        : public boost::
              iterator_facade<TypedColumnIterator<TDT, ValueType>, ValueType, boost::random_access_traversal_tag> {
    ...
    template<typename input_tdt, typename functor>
    requires std::
        is_invocable_r_v<void, functor, typename ColumnData::Enumeration<typename input_tdt::DataTypeTag::raw_type>>
    ...
    requires std::
        is_invocable_r_v<typename output_tdt::DataTypeTag::raw_type, functor, typename input_tdt::DataTypeTag::raw_type>
