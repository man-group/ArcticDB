...
private:
  ...
  // If the fields ctor is used, store the major and minor version numbers as a pair so
  // we can reconstruct the column names
  ...
  from_segment_column_name(std::string_view segment_column_name);
};
