...
std::optional<util::BitSet> check_and_mark_slices(
        const KeySliceContainer& slice_and_keys, bool dynamic_schema, bool return_bitset,
        std::optional<size_t> incompletes_after, bool has_column_groups
) {
...
void decode_into_frame_dynamic(
        const SegmentInMemory& frame, PipelineContextRow& context, const Segment& seg,
