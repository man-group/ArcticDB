...
class BaseIndex {
  public:
    ...
    [[nodiscard]] StreamDescriptor create_stream_descriptor(StreamId stream_id, std::initializer_list<FieldRef> fields)
            const;
...
class TimeseriesIndex : public BaseIndex<TimeseriesIndex> {
  public:
    ...
    static constexpr IndexDescriptorImpl::Type type() { return IndexDescriptorImpl::Type::TIMESTAMP; }
...
class TableIndex : public BaseIndex<TableIndex> {
  public:
    ...
    static constexpr IndexDescriptorImpl::Type type() { return IndexDescriptorImpl::Type::STRING; }
