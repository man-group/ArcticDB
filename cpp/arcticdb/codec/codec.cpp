...
void encode_field_descriptors(
    ...
    if (in_mem_seg.index_fields()) {
        ...
        arcticdb::proto::encoding::VariantCodec index_codec;
        index_codec.CopyFrom(codec_opts);
        encoder.encode(index_codec, index_col, *index_field, out_buffer, pos);
