...
struct Unroller8 {
    ...
    static void PackNoMask(const uint8_t *__restrict in, uint8_t *__restrict out) {
        pack_single_in<uint8_t, DELTA, (DELTA * OINDEX) % 8, uint8_t(-1)>(in[OINDEX], out);
...
struct Unroller16 {
    ...
    static void PackNoMask(const uint16_t *__restrict in, uint16_t *__restrict out) {
        pack_single_in<uint16_t, DELTA, (DELTA * OINDEX) % 16, uint16_t(-1)>(in[OINDEX], out);
...
struct Unroller {
    ...
    static void PackNoMask(const uint32_t *__restrict in, uint32_t *__restrict out) {
        pack_single_in<uint32_t, DELTA, (DELTA * OINDEX) % 32, uint32_t(-1)>(in[OINDEX], out);
...
//fastpackwithoutmask for uint8
void __fastpackwithoutmask1(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<1>::PackNoMask(in, out);
}

void __fastpackwithoutmask2(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<2>::PackNoMask(in, out);
}

void __fastpackwithoutmask3(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<3>::PackNoMask(in, out);
}

void __fastpackwithoutmask4(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<4>::PackNoMask(in, out);
}

void __fastpackwithoutmask5(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<5>::PackNoMask(in, out);
}

void __fastpackwithoutmask6(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<6>::PackNoMask(in, out);
}

void __fastpackwithoutmask7(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<7>::PackNoMask(in, out);
}

void __fastpackwithoutmask8(const uint8_t *__restrict__ in, uint8_t *__restrict__ out) {
    Unroller8<8>::PackNoMask(in, out);
}

//fastpackwithoutmask for uint16
void __fastpackwithoutmask1(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<1>::PackNoMask(in, out);
}

void __fastpackwithoutmask2(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<2>::PackNoMask(in, out);
}

void __fastpackwithoutmask3(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<3>::PackNoMask(in, out);
}

void __fastpackwithoutmask4(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<4>::PackNoMask(in, out);
}

void __fastpackwithoutmask5(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<5>::PackNoMask(in, out);
}

void __fastpackwithoutmask6(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<6>::PackNoMask(in, out);
}

void __fastpackwithoutmask7(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<7>::PackNoMask(in, out);
}

void __fastpackwithoutmask8(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<8>::PackNoMask(in, out);
}

void __fastpackwithoutmask9(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<9>::PackNoMask(in, out);
}

void __fastpackwithoutmask10(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<10>::PackNoMask(in, out);
}

void __fastpackwithoutmask11(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<11>::PackNoMask(in, out);
}

void __fastpackwithoutmask12(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<12>::PackNoMask(in, out);
}

void __fastpackwithoutmask13(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<13>::PackNoMask(in, out);
}

void __fastpackwithoutmask14(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<14>::PackNoMask(in, out);
}

void __fastpackwithoutmask15(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<15>::PackNoMask(in, out);
}

void __fastpackwithoutmask16(const uint16_t *__restrict__ in, uint16_t *__restrict__ out) {
    Unroller16<16>::PackNoMask(in, out);
}
