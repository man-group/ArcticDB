...
void __fastpackwithoutmask59(const uint64_t *__restrict__ in,
                             uint32_t *__restrict__ out);
void __fastpackwithoutmask60(const uint64_t *__restrict__ in, uint32_t *__restrict__ out);
void __fastpackwithoutmask61(const uint64_t *__restrict__ in, uint32_t *__restrict__ out);
void __fastpackwithoutmask62(const uint64_t *__restrict__ in, uint32_t *__restrict__ out);
void __fastpackwithoutmask63(const uint64_t *__restrict__ in, uint32_t *__restrict__ out);
