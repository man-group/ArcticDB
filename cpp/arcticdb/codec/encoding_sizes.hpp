...
template <typename NDArrayEncodedFieldType> std::size_t shape_compressed_size(const NDArrayEncodedFieldType &nda) {
    ...
    /*
    inline std::size_t compressed_size(const DictionaryEncodedFieldType &d) {
...
/*
    template <typename DictionaryEncodedFieldType>
    std::size_t uncompressed_size(const DictionaryEncodedFieldType &d) {
