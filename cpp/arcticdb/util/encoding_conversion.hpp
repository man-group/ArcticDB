...
public:
  ...
  bool convert(const char* input, size_t input_size, uint8_t* output,
               size_t& output_size) {
    return iconv(iconv_, (char**)&input, &input_size, (char**)&output, &output_size) !=
           size_t(-1);
  }
};
...
public:
  ...
  static bool convert(const char* input, size_t input_size, uint8_t* output,
