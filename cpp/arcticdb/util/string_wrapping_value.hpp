...
template <typename BaseType> struct StringWrappingValue : BaseType {
  std::string value;
...
namespace std {
template <typename TagType> struct hash<arcticdb::util::StringWrappingValue<TagType>> {
...
template <typename BaseType> struct formatter<StringWrappingValue<BaseType>> {
