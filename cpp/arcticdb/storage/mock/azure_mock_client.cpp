...
std::string MockAzureClient::get_failure_trigger(
        const std::string& blob_name, StorageOperation operation_to_fail, const std::string& error_code,
...
std::optional<Azure::Core::RequestFailedException> has_failure_trigger(
    ...
    try {
        ...
        auto error_message = fmt::format(
                "Simulated Error, message: operation {}, blob name {} error code {} statuscode {}",
...
Segment MockAzureClient::read_blob(
    ...
    if (pos == azure_contents.end()) {
        ...
        std::string message = fmt::format(
                "Simulated Error, message: Read failed {} {}",
                error_code,
...
void MockAzureClient::delete_blobs(const std::vector<std::string>& blob_names, unsigned int) {
