...
TEST(S3MockStorageTest, TestS3RetryableException) {
    ...
    std::string failureSymbol =
        s3::MockS3Client::get_failure_trigger("sym1", StorageOperation::READ, Aws::S3::S3Errors::NETWORK_CONNECTION);
...
TEST(MongoMockStorageTest, TestPermissionErrorException) {
    ...
    std::string failureSymbol =
        mongo::MockMongoClient::get_failure_trigger("sym1", StorageOperation::READ, mongo::MongoError::UnAuthorized);
    ...
    failureSymbol =
        mongo::MockMongoClient::get_failure_trigger("sym3", StorageOperation::WRITE, mongo::MongoError::UnAuthorized);
...
TEST(MongoMockStorageTest, MongoUnexpectedException) {
    ...
    std::string failureSymbol =
        mongo::MockMongoClient::get_failure_trigger("sym1", StorageOperation::READ, mongo::MongoError::HostNotFound);
