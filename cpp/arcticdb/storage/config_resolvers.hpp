...
public:
  ...
  virtual std::vector<
      std::pair<LibraryPath, arcticdb::proto::storage::LibraryDescriptor>>
  get_libraries(const EnvironmentName& environment_name) const = 0;
  virtual std::vector<std::pair<StorageName, arcticdb::proto::storage::VariantStorage>>
  get_storages(const EnvironmentName& environment_name) const = 0;
  ...
  virtual std::vector<std::pair<StorageName, arcticdb::proto::storage::VariantStorage>>
  get_default_storages(const EnvironmentName& environment_name) const = 0;
...
public:
  typedef std::unordered_map<StorageName, arcticdb::proto::storage::VariantStorage>
      StorageMap;
  typedef std::unordered_map<LibraryPath, arcticdb::proto::storage::LibraryDescriptor>
      LibraryMap;
  ...
  std::vector<std::pair<LibraryPath, arcticdb::proto::storage::LibraryDescriptor>>
  get_libraries(const EnvironmentName& environment_name) const override;
  std::vector<std::pair<StorageName, arcticdb::proto::storage::VariantStorage>>
  get_storages(const EnvironmentName& environment_name) const override;
  ...
  std::vector<std::pair<StorageName, arcticdb::proto::storage::VariantStorage>>
  get_default_storages(const EnvironmentName&) const override {
    return std::vector<
        std::pair<StorageName, arcticdb::proto::storage::VariantStorage>>();
  }
...
private:
  std::optional<MemoryConfig>
  get_environment(const EnvironmentName& environment_name) const;
