...
using VariantStorageOverride =
    std::variant<std::monostate, S3Override, AzureOverride, LmdbOverride>;

class StorageOverride {
  VariantStorageOverride override_;

public:
  const VariantStorageOverride& variant() const { return override_; }
