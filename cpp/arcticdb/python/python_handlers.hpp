...
struct EmptyHandler {
  ...
  void handle_type(const uint8_t*& data, uint8_t* dest,
                   const EncodedFieldImpl& encoded_field, const ColumnMapping& mapping,
                   size_t dest_bytes, const std::shared_ptr<BufferHolder>& buffers,
