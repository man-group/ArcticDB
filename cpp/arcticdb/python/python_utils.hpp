...
inline std::vector<NamedAggregator> named_aggregators_from_list(std::vector<std::pair<std::string, std::variant<std::string, std::pair<std::string, std::string>>>>&& aggregations) {
