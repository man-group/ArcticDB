...
public:
  explicit MinMaxAggregator(ColumnName column_name, ColumnName output_column_name_min,
...
public:
  ...
  SegmentInMemory finalize(const ColumnName& output_column_name, bool dynamic_schema,
...
template <class AggregatorData> class GroupingAggregatorImpl {
public:
  explicit GroupingAggregatorImpl(ColumnName input_column_name,
