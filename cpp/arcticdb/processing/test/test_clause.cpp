...
TEST(Clause, AggregationEmptyColumn) {
    ...
    AggregationClause aggregation("int_repeated_values", {{"empty_sum", "sum"}, {"empty_min", "min"}, {"empty_max", "max"}, {"empty_mean", "mean"}, {"empty_count", "count"}, {"empty_last", "last"}});
    ...
    // Min, max, mean, count and last aggregations should not be present in the output segment
