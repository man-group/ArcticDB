...
class StructureByTimeSlice : public testing::Test {};

TEST_F(StructureByTimeSlice, DisjointTimeRanges_OneColPerRowSlice) {
...
TEST_F(StructureByTimeSlice, DisjointTimeRanges_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 10}, TimestampRange{20, 30}, TimestampRange{40, 50}, TimestampRange{60, 70}
    };
...
TEST_F(StructureByTimeSlice, DisjointTimeRanges_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 10}, TimestampRange{20, 30}, TimestampRange{40, 50}, TimestampRange{60, 70}
    };
...
TEST_F(StructureByTimeSlice, SingleSharedValueTwoRowSlices_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, SingleSharedValueTwoRowSlices_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 10}, TimestampRange{15, 20}, TimestampRange{19, 25}, TimestampRange{30, 50}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 2);
...
TEST_F(StructureByTimeSlice, SingleSharedValueTwoRowSlices_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 10}, TimestampRange{15, 20}, TimestampRange{19, 25}, TimestampRange{30, 50}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 3);
...
TEST_F(StructureByTimeSlice, SharedValueSpansThreeRowSlices_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, SharedValueSpansThreeRowSlices_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15}, TimestampRange{14, 15}, TimestampRange{14, 15}, TimestampRange{20, 36}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 2);
...
TEST_F(StructureByTimeSlice, SharedValueSpansThreeRowSlices_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15}, TimestampRange{14, 15}, TimestampRange{14, 15}, TimestampRange{20, 36}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 3);
...
TEST_F(StructureByTimeSlice, SharedValueSpansFourRowSlices_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, SharedValueSpansFourRowSlices_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15}, TimestampRange{14, 15}, TimestampRange{14, 15}, TimestampRange{14, 16}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 2);
...
TEST_F(StructureByTimeSlice, SharedValueSpansFourRowSlices_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15}, TimestampRange{14, 15}, TimestampRange{14, 15}, TimestampRange{14, 16}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 3);
...
TEST_F(StructureByTimeSlice, Chain_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, Chain_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 5}, TimestampRange{4, 10}, TimestampRange{9, 15}, TimestampRange{14, 20}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 2);
...
TEST_F(StructureByTimeSlice, Chain_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 5}, TimestampRange{4, 10}, TimestampRange{9, 15}, TimestampRange{14, 20}
    };
    std::vector<RangesAndKey> input = generate_ranges_and_keys(time_ranges, 3);
...
TEST_F(StructureByTimeSlice, SingleRowSlice_ThreeColsPerRowSlice) {
...
TEST_F(StructureByTimeSlice, AdjacentTimeRangesShareNoValue_OneColPerRowSlice) {
...
TEST_F(StructureByTimeSlice, TwoSeparateSharedValueGroups_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, MinimalSeamOverlap_OneColPerRowSlice) {
...
TEST_F(StructureByTimeSlice, ChainOfFiveRowSlices_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 5},
            TimestampRange{4, 10},
            TimestampRange{9, 15},
...
TEST_F(StructureByTimeSlice, IsolatedThenCliqueThenIsolatedThenClique_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 10},
...
TEST_F(StructureByTimeSlice, CliqueThenChain_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
...
TEST_F(StructureByTimeSlice, CliqueThenChain_TwoColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15},
            TimestampRange{14, 15},
            TimestampRange{14, 20},
...
TEST_F(StructureByTimeSlice, CliqueThenChain_ThreeColsPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15},
            TimestampRange{14, 15},
            TimestampRange{14, 20},
...
TEST_F(StructureByTimeSlice, TwoCliquesShareBridgingRowSlice_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{10, 15},
            TimestampRange{14, 15},
...
TEST_F(StructureByTimeSlice, ChainInterleavedWithClique_OneColPerRowSlice) {
    constexpr static std::array time_ranges{
            TimestampRange{0, 5},
            TimestampRange{4, 10},
            TimestampRange{9, 15},
...
TEST_F(StructureByTimeSlice, EmptyInput) {
