...
Column SortedAggregator<aggregation_operator, closed_boundary>::aggregate(
    ...
    details::visit_type(
        ...
        [this, &input_index_columns, &input_agg_columns, &bucket_boundaries, &string_pool, &res](
            ...
            // Need this here to only generate valid get_bucket_aggregator code, exception will have been thrown earlier
            // at runtime
            constexpr bool supported_aggregation_type_combo =
                ...
                (is_sequence_type(output_type_info::data_type) && (aggregation_operator == AggregationOperator::FIRST ||
