...
private:
  ...
  // Upper 5 bytes represent the number of bytes of data transferred (giving max
  // representable value of 1TB) Lower 3 bytes represent the total time in milliseconds
  // (giving max representable value of 4.5 hours)
