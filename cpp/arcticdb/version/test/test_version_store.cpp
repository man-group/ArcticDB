...
TEST(PythonVersionStore, IterationVsRefWrite) {
    ...
    version_map->load_via_ref_key(mock_store, stream_id, LoadStrategy{LoadType::LOAD_ALL, true}, ref_entry);
    ...
    version_map->load_via_ref_key(mock_store, stream_id, LoadStrategy{LoadType::LOAD_ALL, true}, ref_entry_compact);
