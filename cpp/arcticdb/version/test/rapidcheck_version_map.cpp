...
struct WriteVersion : rc::state::Command<Model, MapStorePair> {
    ...
    void apply(Model& s0) const override { s0.write_version(symbol_); }
    ...
    void show(std::ostream& os) const override { os << "WriteVersion(" << symbol_ << ")"; }
};
...
struct DeleteAllVersions : rc::state::Command<Model, MapStorePair> {
    ...
    explicit DeleteAllVersions(const Model& s0) : symbol_(*rc::gen::elementOf(s0.symbols_)) {}

    void apply(Model& s0) const override { s0.delete_all_versions(symbol_); }

    void run(const Model&, MapStorePair& sut) const override { sut.delete_all_versions(symbol_); }
...
struct WriteAndPrunePreviousVersion : rc::state::Command<Model, MapStorePair> {
    ...
    void apply(Model& s0) const override { s0.write_and_prune_previous(symbol_); }
    ...
    void show(std::ostream& os) const override { os << "WriteAndPrunePreviousVersion(" << symbol_ << ")"; }
};
...
struct GetLatestVersion : rc::state::Command<Model, MapStorePair> {
    ...
    void show(std::ostream& os) const override { os << "GetLatestVersion(" << symbol_ << ")"; }
};
...
struct Compact : rc::state::Command<Model, MapStorePair> {
    ...
    explicit Compact(const Model& s0) : symbol_(*rc::gen::elementOf(s0.symbols_)) {}
    ...
    void show(std::ostream& os) const override { os << "Compact(" << symbol_ << ")"; }
};
...
struct DeleteRefKey : rc::state::Command<Model, MapStorePair> {
    ...
    explicit DeleteRefKey(const Model& s0) : symbol_(*rc::gen::elementOf(s0.symbols_)) {}
