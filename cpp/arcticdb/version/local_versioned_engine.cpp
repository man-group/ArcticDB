...
VersionedItem LocalVersionedEngine::read_modify_write_internal(
    ...
    IndexInformation index_info = read_index_key_without_column_stats(store(), source_version->key_);
    std::shared_ptr<PipelineContext> pipeline_context =
            setup_pipeline_context(store(), *source_version, *read_query, read_options, std::move(index_info));
