...
class PrometheusInstance {
  public:
    ...
    void removeMetric(const std::string& name, const Labels& labels) {
        ...
        static_assert(
            T::metric_type == prometheus::MetricType::Counter || T::metric_type == prometheus::MetricType::Histogram ||
                T::metric_type == prometheus::MetricType::Gauge || T::metric_type == prometheus::MetricType::Summary,
