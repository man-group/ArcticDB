...
TEST(Key, Basic) {
    ...
    auto numeric_key_from_bytes = atom_key_from_bytes(
            reinterpret_cast<uint8_t*>(numeric_key_string.data()), numeric_key_string.size(), numeric_data_key_type
    );
    ...
    auto string_key_from_bytes = atom_key_from_bytes(
            reinterpret_cast<uint8_t*>(string_key_string.data()), string_key_string.size(), string_data_key_type
    );
    ...
    auto string_index_from_bytes = atom_key_from_bytes(
            reinterpret_cast<uint8_t*>(string_index_key_string.data()),
