...
#define ARCTICDB_SAMPLE(name, flags)                                                   \
  arcticdb::ScopedTimer timer{#name, [](auto msg) { std::cout << msg; }};
...
#define ARCTICDB_SAMPLE_DEFAULT(name)                                                  \
  arcticdb::ScopedTimer default_timer{#name, [](auto msg) { std::cout << msg; }};
