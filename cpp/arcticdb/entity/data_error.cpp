...
void DataError::set_error_code(ErrorCode error_code) {
    error_code_ = error_code;
}

std::string DataError::symbol() const {
...
std::optional<ErrorCode> DataError::error_code() const {
    return error_code_;
}
...
std::string DataError::exception_string() const {
