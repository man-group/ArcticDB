...
struct KeyData {
  KeyData()
      : long_name_("undefined"), short_name_('u'),
        variant_type_(VariantType::UNKNOWN_TYPE), key_class_(KeyClass::UNKNOWN_CLASS),
        description_() {}

  KeyData(const char* long_name, char short_name, VariantType variant_type,
          KeyClass key_class, const char* description)
      : long_name_(long_name), short_name_(short_name), variant_type_(variant_type),
        key_class_(key_class), description_(description) {}
