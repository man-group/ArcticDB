...
struct formatter<arcticdb::proto::descriptors::StreamDescriptor_FieldDescriptor> {
    ...
    template<typename FormatContext>
    auto format(const arcticdb::proto::descriptors::StreamDescriptor_FieldDescriptor& field_desc, FormatContext& ctx)
            const {
...
struct formatter<arcticdb::proto::descriptors::NormalizationMetadata::InputTypeCase> {
    ...
    template<typename FormatContext>
    auto format(const arcticdb::proto::descriptors::NormalizationMetadata::InputTypeCase& type, FormatContext& ctx)
            const {
        switch (type) {
        case arcticdb::proto::descriptors::NormalizationMetadata::kDf:
            return fmt::format_to(ctx.out(), "DataFrame");
        case arcticdb::proto::descriptors::NormalizationMetadata::kSeries:
            return fmt::format_to(ctx.out(), "Series");
        case arcticdb::proto::descriptors::NormalizationMetadata::kTs:
            return fmt::format_to(ctx.out(), "TimeSeries");
        case arcticdb::proto::descriptors::NormalizationMetadata::kMsgPackFrame:
        ...
        case arcticdb::proto::descriptors::NormalizationMetadata::kArrowTable:
