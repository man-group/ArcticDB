...
set_target_properties(Folly::folly_deps PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "fmt::fmt;Threads::Threads;Boost::boost;Boost::context;Boost::filesystem;Boost::program_options;Boost::regex;Boost::system;Boost::thread;double-conversion::double-conversion;glog::glog;gflags::gflags;libevent::core;libevent::extra;libevent::pthreads;\$<\$<NOT:\$<CONFIG:DEBUG>>:${VCPKG_IMPORT_PREFIX}/$<$<CONFIG:DEBUG>:debug/>lib/libssl.a>;\$<\$<CONFIG:DEBUG>:${VCPKG_IMPORT_PREFIX}/$<$<CONFIG:DEBUG>:debug/>lib/libssl.a>;\$<\$<NOT:\$<CONFIG:DEBUG>>:${VCPKG_IMPORT_PREFIX}/$<$<CONFIG:DEBUG>:debug/>lib/libcrypto.a>;\$<\$<CONFIG:DEBUG>:${VCPKG_IMPORT_PREFIX}/$<$<CONFIG:DEBUG>:debug/>lib/libcrypto.a>;-pthread;lz4::lz4;dl"
)
