...
vcpkg_from_github(
    ...
    HEAD_REF main
    # ArcticDB overlay: sparrow unconditionally defines _LIBCPP_DISABLE_AVAILABILITY
    # when libc++ is detected. On macOS that makes libc++ emit strong references to
    # newer system-dylib symbols (e.g. std::__hash_memory) that are absent on our
    # deployment target, so the back-deployed wheel fails to dlopen on older macOS.
    # The patch keeps the annotations enabled on Apple.
    PATCHES
        0001-keep-libcpp-availability-on-apple.patch
)
