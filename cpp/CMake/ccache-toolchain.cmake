...
if(CCACHE_PROGRAM AND NOT CMAKE_C_COMPILER_LAUNCHER AND NOT CMAKE_CXX_COMPILER_LAUNCHER)
    set(CMAKE_C_COMPILER_LAUNCHER "env;CCACHE_HARDLINK=1;${CCACHE_PROGRAM}" CACHE STRING "")
    set(CMAKE_CXX_COMPILER_LAUNCHER "env;CCACHE_HARDLINK=1;${CCACHE_PROGRAM}" CACHE STRING "")
endif()
