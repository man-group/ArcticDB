...
| 5040       | An unexpected RocksDB error occurred.                                                                                       | Varies depending on the type of failure. Check [RocksDB statuses](https://github.com/facebook/rocksdb/blob/main/util/status.cc).                                                                                                                                                                    |
