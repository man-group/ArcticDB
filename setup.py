...
ARTICDB_BUILD_CPP_TESTS = os.environ.get("ARTICDB_BUILD_CPP_TESTS", "0")
ARTICDB_BUILD_CPP_TESTS = ARTICDB_BUILD_CPP_TESTS != "0"
print(f"ARTICDB_BUILD_CPP_TESTS={ARTICDB_BUILD_CPP_TESTS}")
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        _log_and_run(
            cmake,
            f"-DTEST={int(ARTICDB_BUILD_CPP_TESTS)}",
