...
class ReadWriteBenchmarkSettings(GeneralSetupLibraryWithSymbols):
    ...
    def generate_dataframe(self, row_num: int, col_num: int) -> pd.DataFrame:
        ...
        df = (
            ...
            .add_bool_col("bool")
            .add_timestamp_index(
                "time", ReadWriteBenchmarkSettings.INDEX_FREQ, ReadWriteBenchmarkSettings.START_DATE_INDEX
            )
        ).generate_dataframe()
