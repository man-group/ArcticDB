...
class AWSBugWide30K:
    ...
    def setup_cache(self):
        return self.initialize_cache(AWSBugWide30K.SETUP_CLASS,
                                     AWSBugWide30K.warmup_time,
                                     AWSBugWide30K.params)
...
class AWSBugWide30K_2(AWSBugWide30K):
    ...
    def setup_cache(self):
        return self.initialize_cache(AWSBugWide30K_2.SETUP_CLASS,
                                     AWSBugWide30K_2.warmup_time,
                                     AWSBugWide30K_2.params)