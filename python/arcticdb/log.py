...
The rationale here is not to reinvent logging in python, but to homogeneise logging in python and c++ layers and use
the same logging categories so that both end-up in the same sinks.
"""
import traceback
