...
def real_gcp_from_environment_variables(
    ...
    from arcticdb_ext.storage import NativeVariantStorage, GCPXMLSettings as NativeGCPXMLSettings
    native_settings = NativeGCPXMLSettings()
    native_settings.bucket = "aseaton_bucket"
    native_settings.endpoint = "http://storage.googleapis.com"# os.getenv("ARCTICDB_REAL_GCP_ENDPOINT")
    native_settings.access = "<redacted>"
    native_settings.secret = "<redacted>"
