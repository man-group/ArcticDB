...
def set_log_level(
    default_level=Defaults.DEFAULT_LOG_LEVEL, specific_log_levels=None, console_output=True, file_output=None
):
    """
    ...
    """
    return configure(make_loggers_config(default_level, specific_log_levels, console_output, file_output), force=True)
