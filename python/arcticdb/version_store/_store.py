...
from arcticdb.options import OutputFormat, output_format_to_internal
...
class NativeVersionStore:
    ...
    def _postprocess_df_with_only_rowcount_idx(self, read_result, row_range):
        ...
        if read_result.output_format == InternalOutputFormat.PANDAS:
            data = pd.DataFrame({}, index=index)
        elif read_result.output_format == InternalOutputFormat.ARROW:
