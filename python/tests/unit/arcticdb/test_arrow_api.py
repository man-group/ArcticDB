...
all_output_format_args = [None, OutputFormat.PANDAS, "PANDAS", OutputFormat.EXPERIMENTAL_ARROW, "EXPERIMENTAL_ARROW"]
no_str_output_format_args = [None, OutputFormat.PANDAS, OutputFormat.EXPERIMENTAL_ARROW]


def expected_output_type(arctic_output_format, output_format_override):
    expected_output_format = output_format_override or arctic_output_format
    return pa.Table if expected_output_format == OutputFormat.EXPERIMENTAL_ARROW else pd.DataFrame


@pytest.mark.parametrize("arctic_output_format", all_output_format_args)
@pytest.mark.parametrize("output_format_override", all_output_format_args)
def test_read_arctic(lmdb_storage, lib_name, arctic_output_format, output_format_override):
    ...
    assert isinstance(result, expected_output_type(arctic_output_format, output_format_override))
...
def test_read_batch(lmdb_storage, lib_name, arctic_output_format, output_format_override):
    ...
    output_type = expected_output_type(arctic_output_format, output_format_override)
