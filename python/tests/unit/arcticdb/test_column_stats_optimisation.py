...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(lambda q: q["col_1"].isin([3, 5, 6]),
                     lambda df: df["col_1"].isin([3, 5, 6]),
                     1, id="isin_prunes_seg0"),
        pytest.param(lambda q: q["col_1"].isin([1, 2]),
                     lambda df: df["col_1"].isin([1, 2]),
                     1, id="isin_prunes_seg1"),
        pytest.param(lambda q: q["col_1"].isin([100, 200]),
                     lambda df: df["col_1"].isin([100, 200]),
                     0, id="isin_prunes_both"),
        pytest.param(lambda q: q["col_1"].isin([1, 2, 5, 6]),
                     lambda df: df["col_1"].isin([1, 2, 5, 6]),
                     2, id="isin_overlaps_both"),
        pytest.param(lambda q: ~q["col_1"].isin([5, 6, 7]),
                     lambda df: ~df["col_1"].isin([5, 6, 7]),
                     2, id="negated_isin_no_pruning"),
        pytest.param(lambda q: q["col_1"].isnotin([5, 6, 7]),
                     lambda df: ~df["col_1"].isin([5, 6, 7]),
                     2, id="isnotin_no_pruning"),
        pytest.param(lambda q: q["col_1"].isnotin([100, 200]),
                     lambda df: ~df["col_1"].isin([100, 200]),
                     2, id="isnotin_no_pruning_disjoint"),
        pytest.param(lambda q: q["col_1"].isnotin([5]),
                     lambda df: ~df["col_1"].isin([5]),
                     1, id="isnotin_prunes_seg1"),
        pytest.param(lambda q: ~q["col_1"].isnotin([5]),
                     lambda df: df["col_1"].isin([5]),
                     1, id="negated_isnotin_prunes_seg0"),
    ]
)
