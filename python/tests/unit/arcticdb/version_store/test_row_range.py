...
def row_range_test_with_any_output_format(version_store, symbol, df, start_row, end_row):
    """Helper function for row range tests that works with any output format."""
    ...
    assert_frame_equal_with_arrow(expected_array, received_array)
    assert_frame_equal_with_arrow(expected_array, received_array_via_querybuilder)
...
def test_row_range_start_row_greater_than_end_row(lmdb_version_store, one_col_df, any_output_format):
    ...
    row_range_test_with_any_output_format(lmdb_version_store, "test_row_range_start_row_greater_than_end_row", one_col_df(), 3, 2)


def test_row_range_zero_num_rows(lmdb_version_store, one_col_df, any_output_format):
    lmdb_version_store.set_output_format(any_output_format)
    row_range_test_with_any_output_format(lmdb_version_store, "test_row_range_zero_num_rows", one_col_df(), 2, 2)
...
def test_row_range_one_num_rows(lmdb_version_store_tiny_segment, one_col_df, any_output_format):
    ...
    row_range_test_with_any_output_format(lmdb_version_store_tiny_segment, "test_row_range_one_num_rows", one_col_df(), 2, 3)
...
def test_row_range_multiple_segments(lmdb_version_store_tiny_segment, one_col_df, any_output_format):
    # lmdb_version_store_tiny_segment has segment_row_size set to 2
    lmdb_version_store_tiny_segment.set_output_format(any_output_format)
    row_range_test_with_any_output_format(lmdb_version_store_tiny_segment, "test_row_range_multiple_segments", one_col_df(), 3, 7)
...
def test_row_range_all_rows(lmdb_version_store_tiny_segment, one_col_df, any_output_format):
    ...
    lmdb_version_store_tiny_segment.set_output_format(any_output_format)
    row_range_test_with_any_output_format(lmdb_version_store_tiny_segment, "test_row_range_all_rows", one_col_df(), 0, 10)


def test_row_range_past_end(lmdb_version_store_tiny_segment, one_col_df, any_output_format):
    # one_col_df generates a dataframe with 10 rows
    lmdb_version_store_tiny_segment.set_output_format(any_output_format)
    row_range_test_with_any_output_format(lmdb_version_store_tiny_segment, "test_row_range_past_end", one_col_df(), 5, 15)
...
def test_row_range_with_column_filter(lmdb_version_store_tiny_segment, three_col_df):
    ...
    lmdb_version_store_tiny_segment.read(symbol, row_range.set_output_format(any_output_format)
    )
...
def test_row_range_pickled_symbol(lmdb_version_store, any_output_format):
    ...
    _.set_output_format(any_output_format)
...
def test_row_range_open_ended(lmdb_version_store_v1, api, row_range, expected, any_output_format):
    ...
    received.set_output_format(any_output_format)
    elif api == "read":
