...
def test_filter_unfilterable_data(lmdb_version_store_v1, empty, data, sym, recursive_normalizer_meta_structure_v2):
    lib = lmdb_version_store_v1
...
def test_head_tail_unfilterable_data(lmdb_version_store_v1, head, sym, data, recursive_normalizer_meta_structure_v2):
    lib = lmdb_version_store_v1
    lib.write(sym, data, recursive_normalizers=True)
