...
@pytest.mark.parametrize(
    "date_range",
    [
        pytest.param((pd.Timestamp("2025-01-03 12:00:00"), pd.Timestamp("2025-01-04 12:00:00")), id="single_value"),
        pytest.param((pd.Timestamp("2025-01-03"), pd.Timestamp("2025-01-03 23:59:59.999999999")), id="single_day"),
