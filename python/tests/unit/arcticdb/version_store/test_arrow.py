...
#
# def test_test(lmdb_version_store_v1):
#     lib = lmdb_version_store_v1
#     df = pd.DataFrame({"col": [1, 2, 3]})
#     df_index = pd.DataFrame({"col": [1, 2, 3]}, index=pd.date_range(pd.Timestamp(2025, 1, 1), periods=3))
#     df_non_ts_index = pd.DataFrame({"col": [1, 2, 3]}, index=["a", "b", "c"])
#     lib.write("sym", df)
#     lib.write("sym_index", df_index)
#     lib.write("sym_non_ts_index", df_index)
#     # print(lib.get_info("sym")["normalization_metadata"])
#     # print(lib.get_info("sym_index"))
#     # print(lib.get_info("sym_non_ts_index"))
#     print(lib.read("sym_index", output_format=OutputFormat.ARROW).data)
#     assert False
