...
def test_restore_version_as_of(lmdb_version_store):
    ...
    restore_item = lib.restore_version(sym, as_of=first_ts)
    ...
    restore_item = lib.restore_version(sym, as_of=second_ts)
    ...
    restore_item = lib.restore_version(sym, as_of=third_ts)
