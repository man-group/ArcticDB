...
from tests.util.mark import ARCTICDB_USING_CONDA, ZONE_INFO_MARK, MACOS
...
if MACOS:
    pytest.skip(
        "These tests are not supported on macOS because we haven't published any past versions yet",
