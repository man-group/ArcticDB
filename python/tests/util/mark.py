...
AZURE_TESTS_MARK = pytest.mark.skipif(True or FAST_TESTS_ONLY or MACOS_CONDA_BUILD or not LOCAL_STORAGE_TESTS_ENABLED,
...
MONGO_TESTS_MARK = pytest.mark.skipif(
    True or FAST_TESTS_ONLY or sys.platform != "linux" or not LOCAL_STORAGE_TESTS_ENABLED,
